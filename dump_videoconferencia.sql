...
--
-- Host: localhost    Database: gestion_videoconferencias
-- ------------------------------------------------------
...
INSERT INTO `participante_videoconferencia` VALUES (1,1,'Perez','Juan','juanperez@gmail.com'),(2,2,'Pedro','Fernandez','pedrof@gmail.com'),(3,2,'Fernando','Garcia','Garciaf@gmail.com');
...
--
-- Table structure for table `videoconferencia_participante`
--

DROP TABLE IF EXISTS `videoconferencia_participante`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `videoconferencia_participante` (
  `videoconferencia` bigint(20) NOT NULL,
  `participante_videconferencia` bigint(20) NOT NULL,
  KEY `videoconferencia` (`videoconferencia`),
  KEY `participante_videconferencia` (`participante_videconferencia`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `videoconferencia_participante`
--

LOCK TABLES `videoconferencia_participante` WRITE;
/*!40000 ALTER TABLE `videoconferencia_participante` DISABLE KEYS */;
INSERT INTO `videoconferencia_participante` VALUES (4,1),(4,2),(4,3),(2,3),(3,3),(2,3);
/*!40000 ALTER TABLE `videoconferencia_participante` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `videoconferencias` VALUES (2,'2019-12-04','12:48:34',1,1,2,'asdasd','asdasdsad',1),(3,'2019-12-03','12:48:34',1,1,2,'asdasd','asdasdsad',1),(4,'2019-12-02','12:48:34',2,1,2,'asdasd','asdasdsad',1);
...
-- Dump completed on 2019-12-05 14:55:20
